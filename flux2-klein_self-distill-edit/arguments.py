...
def parse_args():
    ...
    parser.add_argument("--edit-sys-prompt", type=str, default="", help="system text prompt for edit teacher branch.")
    ...
    parser.add_argument("--final-sample-resolution-scale", type=float, default=1.0,
                        help="Scale only final sample image generation. Use below 1.0 for block-offload low-VRAM fallback.")
    ...
    parser.add_argument("--final-sampler-cpu-offload", action=argparse.BooleanOptionalAction, default=True,
                        help="Use Diffusers model CPU offload for deferred final sampling.")
    ...
    parser.add_argument("--tiled-vae", action=argparse.BooleanOptionalAction, default=True,
                        help="Use tiled VAE encode/decode for low-VRAM final sampling.")
    parser.add_argument("--vae-tile-size", type=int, default=64,
                        help="Pixel tile size for tiled VAE final sampling.")
    parser.add_argument("--vae-tile-overlap", type=float, default=0.25,
                        help="Tile overlap factor for tiled VAE final sampling.")
